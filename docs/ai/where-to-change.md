...
| app-server request/response handling | `CodexAppMobile/Features/Orchestration/AppServerClient.swift`, `CodexAppMobile/Features/Orchestration/AppServerDomain.swift` |
| Hosts/Sessions screen UI | `CodexAppMobile/Features/Orchestration/CodexOrchestrationViews.swift` |
| Chat/workbench UI behavior | `CodexAppMobile/Features/Orchestration/SessionWorkbenchView.swift` |
...
| SSH terminal behavior or known hosts flow | `CodexAppMobile/Features/Terminal/ContentView.swift` |
